...
if (isset($_POST['simpan'])) {
    ...
    $user->insert($username, $password, $role);
...
<head>
    ...
    <title>Tambah User - Admin Panel Berita</title>
...
<body>
    ...
    <div class="container-main">
        <div class="page-header">
            <h1><i class="fas fa-users-cog me-3"></i>Tambah User Baru</h1>
            <p>Buat akun pengguna baru untuk mengelola platform berita Anda.</p>
        </div>
