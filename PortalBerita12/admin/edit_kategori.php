...
<head>
    ...
    <title>Edit Kategori - Admin Panel Berita</title>
...
<body>
    ...
    <div class="container-main">
        <div class="page-header">
            <h1><i class="fas fa-edit me-3"></i>Edit Kategori</h1>
            <p>Perbarui nama kategori untuk menjaga organisasi konten berita yang optimal.</p>
        </div>
                ...
                <form method="post">
                    <div class="form-floating position-relative mb-4">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" 
                               value="<?= htmlspecialchars($data['nama_kategori']) ?>" placeholder="Nama Kategori" required>
