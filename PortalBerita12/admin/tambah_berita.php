...
if (isset($_POST['simpan'])) {
    ...
    $berita->insert($judul, $konten, $foto, $kategori_id, $user_id);
...
<head>
    ...
    <title>Tambah Berita - Admin Panel Berita</title>
...
<body>
    ...
    <div class="container-main">
        <div class="page-header">
            <h1><i class="fas fa-file-alt me-3"></i>Tambah Berita Baru</h1>
            <p>Buat artikel berita baru dengan konten menarik untuk platform Anda.</p>
        </div>
            ...
            <div class="card form-card">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating position-relative mb-3">
                        ...
                        <textarea name="konten" class="form-control" id="konten" placeholder="Konten Berita" required></textarea>
                    ...
                    <div class="file-input-wrapper position-relative mb-4">
        ...
        document.getElementById('foto').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    // Bisa tambah preview image jika diperlukan
                    console.log('Preview ready:', e.target.result);
                };
