...
<head>
    ...
    <title>Manajemen Kategori - Admin Panel Berita</title>
...
<body>
    ...
    <div class="container-main">
        <div class="page-header">
            <h1><i class="fas fa-tags me-3"></i>Manajemen Kategori</h1>
            <p>Kelola kategori berita untuk organisasi konten yang lebih baik di platform Anda.</p>
        </div>

        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0 fw-bold text-dark"><i class="fas fa-list me-2"></i>Data Kategori</h3>
            <a href="tambah_kategori.php" class="btn btn-success btn-modern">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card kategori-card">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="kategori-content flex-grow-1">
                            <span class="kategori-name"><?= htmlspecialchars($row['nama_kategori']) ?></span>
                            <div class="kategori-meta">
                                <i class="fas fa-hashtag me-1"></i>ID: <?= $row['id'] ?> | No: <?= $no ?>
                            </div>
                        </div>
                        <div class="action-buttons ms-3">
                            <a href="edit_kategori.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-action">
                                <i class="fas fa-edit me-1"></i>Edit
                            </a>
                            <a href="hapus_kategori.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin hapus?')" class="btn btn-danger btn-action">
            ...
            <div class="col-12">
                <div class="no-data">
                    ...
                    <p>Tidak ada data kategori saat ini. Tambahkan kategori baru untuk memulai!</p>
                </div>
            </div>
            <?php } ?>
        </div>
