...
<head>
    ...
    <title>Manajemen User - Admin Panel Berita</title>
...
<body>
    ...
    <div class="container-main">
        <div class="page-header">
            ...
            <p>Kelola akun pengguna dengan mudah dan aman untuk platform berita Anda.</p>
        </div>

        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0 fw-bold text-dark"><i class="fas fa-list me-2"></i>Data User</h3>
            <a href="tambah_user.php" class="btn btn-success btn-modern">
        ...
        <div class="row">
                ...
                <div class="card user-card">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="user-info flex-grow-1">
                            ...
                            <p class="mb-1"><i class="fas fa-user-tag me-1"></i>ID: <?= $row['id'] ?></p>
                            <span class="role-badge"><?= ucfirst($row['role']) ?></span>
                        </div>
                        <div class="action-buttons">
                            <a href="edit_user.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-action">
                                <i class="fas fa-edit me-1"></i>Edit
                            </a>
                            <a href="hapus_user.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin hapus user ini?')" class="btn btn-danger btn-action">
            ...
            <div class="col-12">
                <div class="no-data">
                    ...
                    <p>Tidak ada data user saat ini. Tambahkan user baru untuk memulai!</p>
                </div>
            </div>
            <?php } ?>
        </div>
